...
import com.anantadwi13.cataloguemovie.Widget.NewAppWidget;
...
public class DetailActivity extends AppCompatActivity implements View.OnClickListener {
    public static String EXTRA_ITEM = "extra_item", EXTRA_REMOVED ="extra_changed", EXTRA_FROM_WIDGET="extra_from_widget";
    ...
    private Film film;
    private boolean isRemoved =false, isFromWidget=false;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        isFromWidget = getIntent().getBooleanExtra(EXTRA_FROM_WIDGET,false);
        if (film!=null){
    ...
    public void onBackPressed() {
        /*if (isFromWidget){
            ...
            main.putExtra(EXTRA_FROM_WIDGET,true);
            startActivity(main);
            finish();
        }
        else if (isRemoved){
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.fav:
                ...
                appWidgetManager.notifyAppWidgetViewDataChanged(appWidgetManager.getAppWidgetIds(new ComponentName(this, NewAppWidget.class)),R.id.stackview);*/
